...
import { Github, Linkedin, Mail, Phone, MapPin, Code, Database, Globe, Terminal, ChevronDown, ExternalLink, BookOpen, Award, User, Briefcase, X, Menu, Sparkles, ArrowRight, Star, Calendar, Map } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="text-2xl font-bold text-gradient hover:scale-105 transition-transform duration-200 focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:ring-offset-2 focus:ring-offset-transparent rounded-sm"
            ...
            <div className="glass-effect p-6 rounded-2xl hover-lift">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.languages.map((skill) => (
                  <span key={skill} className="bg-blue-500/20 px-3 py-1 rounded-full text-sm hover:bg-blue-500/40 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="glass-effect p-6 rounded-2xl hover-lift">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.frameworks.map((skill) => (
                  <span key={skill} className="bg-purple-500/20 px-3 py-1 rounded-full text-sm hover:bg-purple-500/40 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="glass-effect p-6 rounded-2xl hover-lift">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.technologies.map((skill) => (
                  <span key={skill} className="bg-green-500/20 px-3 py-1 rounded-full text-sm hover:bg-green-500/40 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="glass-effect p-6 rounded-2xl hover-lift">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.web.map((skill) => (
                  <span key={skill} className="bg-orange-500/20 px-3 py-1 rounded-full text-sm hover:bg-orange-500/40 transition-colors">
                    {skill}
                  </span>
                ))}
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => {
              ...
              return (
                <div
                  key={index}
                  className="glass-effect p-6 rounded-2xl hover-lift overflow-hidden group"
                >
                  {/* Project Image */}
